declare namespace __AdaptedExports {
   ...
   * @returns `src/core/Computer/Computer`
   */
   ...
   * @param computer `src/core/Computer/Computer`
   * @param valPtr `usize`
   * @param dataLen `i32`
   */
  ...
  /**
   * src/index/computerSetIrqHandler
   * @param computer `src/core/Computer/Computer`
   * @param lo `u8`
   * @param hi `u8`
   */
  export function computerSetIrqHandler(computer: __Internref4, lo: number, hi: number): void;
  /**
   * src/index/computerEnableIrq
   * @param computer `src/core/Computer/Computer`
   * @param mask `u8`
   */
  export function computerEnableIrq(computer: __Internref4, mask: number): void;
}
/** src/core/Computer/Computer */
